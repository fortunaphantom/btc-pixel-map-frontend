...
export const HomePageContent: NextPage = function () {
  return (
    <div className="p-6">
      ...
      <section>
        <header>
          <h2 className="mb-3 text-4xl font-bold dark:text-slate-200">Alert</h2>
        </header>
        <AlertsExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-slate-200">
            Accordion
          </h2>
        </header>
        <AccordionExample />
  ...
  return (
    <div className="flex flex-col justify-center gap-4">
      <Rating>
        ...
        <p className="ml-2 text-sm font-medium text-slate-500 dark:text-slate-400">
          4.95 out of 5
        </p>
      </Rating>
