...
const confirmSteps: ConfirmStep[] = [
  {
    ...
    description:
      "You'll be asked to review and transact cancel transaction for list from your wallet.",
  },
];
...
export const CancelForm: FC<Props> = ({ id, tokenId }) => {
  ...
  return (
    <div className="mt-2 flex flex-col">
      ...
      >
        {confirmOpen ? "Canceling auction..." : "Cancel auction"}
      </Button>
      <ConformModal
